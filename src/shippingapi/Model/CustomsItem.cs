...
namespace shippingapi.Model
{
    ...
    public partial class CustomsItem : IEquatable<CustomsItem>, IValidatableObject
    {
        ...
        public CustomsItem(string brand = default(string), string condition = default(string), string description = default(string), string eccn = default(string), List<string> hazmats = default(List<string>),string hSTariffCode = default(string), HSTariffCodeCountryEnum? hSTariffCodeCountry = default(HSTariffCodeCountryEnum?), List<Identifiers> identifiers = default(List<Identifiers>), List<string> imageURL = default(List<string>), Dimension itemDimension = default(Dimension), string itemId = default(itemId), string manufacturer = default(manufacturer), NetCostMethodEnum? netCostMethod = default(NetCostMethodEnum?), string originCountryCode = default(string), string originStateProvince = default(string), PreferenceCriterionEnum? preferenceCriterion = default(PreferenceCriterionEnum?), Address producerAddress = default(Address), ProducerDeterminationEnum? producerDetermination = default(ProducerDeterminationEnum?), string producerId = default(string), int quantity = default(int), string quantityUOM = default(string), decimal unitPrice = default(decimal), ParcelWeight unitWeight = default(ParcelWeight)), string url = default(url)
        {
       ...
       public string Manufacturer { get; set; }
        ...
        public ParcelWeight Url { get; set; }
